...
export type LoanType   = 'trading' | 'business' | 'house' | 'land' | 'study' | 'emergency';
...
const LoanSchema = new Schema<ILoan>({
  ...
  loanType:            { type: String, enum: ['trading','house','business','study','land','emergency'], required: true },
  requestedAmount:     { type: Number, required: true, min: 100 },
  approvedAmount:      Number,
  disbursedAmount:     Number,
